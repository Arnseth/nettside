...
export default function IndexSectionFeatures2() {
  ...
  <div className="pt-16 pb-24 px-5 xs:px-8 xl:px-12 rounded-3xl">
        ...
        <div className="flex flex-wrap -mx-4">
          <div className="w-full sm:w-1/2 lg:w-1/4 px-4 mb-12 lg:mb-0">
            <div>
              ...
              <div className="mt-6">
                <h5 className="text-2xl font-medium mb-3">EV charging </h5>
                <p className="text-gray-700 mb-6">EVs use electricity as a power source, which can be generated from renewable energy sources. Our solutions help reducing greenhouse gas emissions in the transportation sector.</p>
                <a href="#" className="inline-block text-lg  font-medium hover:text-teal-800">Read more</a>
              </div>
            </div>
          </div>
          <div className="w-full sm:w-1/2 lg:w-1/4 px-4 mb-12 lg:mb-0">
            <div>
              ...
              <div className="mt-6">
                <h5 className="text-2xl font-medium mb-3">Solar Energy</h5>
                <p className="text-gray-700 mb-6">Solar panels convert sunlight into electricity. Photovoltaic (PV) cells on these panels capture the energy from the sun and convert it into electrical power.</p>
                <a href="#" className="inline-block text-lg  font-medium hover:text-teal-800">Read more</a>
              </div>
            </div>
          </div>
          <div className="w-full sm:w-1/2 lg:w-1/4 px-4 mb-12 sm:mb-0">
            <div>
              ...
              <div className="mt-6">
                <h5 className="text-2xl font-medium mb-3">Wind Energy</h5>
                <p className="text-gray-700 mb-6">Wind turbines harness the kinetic energy of the wind to generate electricity. Wind farms with multiple turbines are commonly used to produce large amounts of clean energy.</p>
                <a href="#" className="inline-block text-lg  font-medium hover:text-teal-800">Read more</a>
              </div>
            </div>
          </div>
          <div className="w-full sm:w-1/2 lg:w-1/4 px-4">
            <div>
              ...
              <div className="mt-6">
                <h5 className="text-2xl font-medium mb-3">Hydropower</h5>
                <p className="text-gray-700 mb-6">This technology uses the energy from flowing water, such as rivers and dams, to turn turbines and generate electricity. It's one of the oldest forms of renewable energy.</p>
                <a href="#" className="inline-block text-lg  font-medium hover:text-teal-800">Read more</a>
              </div>
            </div>
          </div>
