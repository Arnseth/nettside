...
export default function IndexSectionHeaders1() {
  ...
  <nav className="mb-16 py-6 border-b">
    <div className="container mx-auto px-4">
      <div className="relative flex items-center justify-between">
        ...
        <ul className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 hidden md:flex">
          <li className="mr-8"><a className="inline-block text-teal-900 hover:text-teal-700 font-medium" href="#">Hjem</a></li>
          <li className="mr-8"><a className="inline-block text-teal-900 hover:text-teal-700 font-medium" href="#">Om Oss</a></li>
          <li className="mr-8"><a className="inline-block text-teal-900 hover:text-teal-700 font-medium" href="#">Tjenester</a></li>
          <li><a className="inline-block text-teal-900 hover:text-teal-700 font-medium" href="#">Blogg</a></li>
        </ul>
        <div className="flex items-center justify-end">
          <div className="hidden md:block">
            <a href="#" className="inline-flex group py-2.5 px-4 items-center justify-center text-sm font-medium text-teal-900 hover:text-white border border-teal-900 hover:bg-teal-900 rounded-full transition duration-200">
              <span className="mr-2">Kontakt Oss</span>
    ...
    <div className="flex flex-wrap -mx-4 items-center">
      <div className="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
        <div className="max-w-lg lg:max-w-none mx-auto">
          <h1 className="font-heading text-5xl xs:text-6xl sm:text-7xl xl:text-8xl tracking-tight mb-8">The Future of Green Energy</h1>
          ...
          <a href="#" className="inline-flex py-4 px-6 items-center justify-center text-lg font-medium text-white hover:text-teal-900 border border-teal-900 hover:border-lime-500 bg-teal-900 hover:bg-lime-500 rounded-full transition duration-200">Se Våre Løsninger</a>
        </div>
      </div>
      <div className="w-full lg:w-1/2 px-4">
        <div className="relative max-w-lg mx-auto lg:mr-0">
          <img className="block w-full relative rounded-2xl" src="flow-assets/headers/photo-men-right.png" alt />
          <a href="#" className="absolute bottom-0 left-0 group inline-flex p-6 m-4 sm:m-6 items-center font-medium bg-white hover:bg-lime-50 rounded-md transition duration-150">
            <svg width={21} height={20} viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M0.5 4C0.5 1.79086 2.29086 0 4.5 0H16.5C18.7091 0 20.5 1.79086 20.5 4V16C20.5 18.2091 18.7091 20 16.5 20H4.5C2.29086 20 0.5 18.2091 0.5 16V4Z" fill="#BEF264" />
              <circle cx="7.16667" cy="6.66667" r="1.66667" fill="#022C22" />
              <ellipse cx="10.5002" cy="13.3333" rx="1.66667" ry="1.66667" fill="#022C22" />
              <circle cx="13.8332" cy="6.66667" r="1.66667" fill="#022C22" />
            </svg>                                    
            ...
            <span className="transform group-hover:translate-x-1 transition duration-150">
              <svg width={21} height={20} viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M5.25 10H15.75" stroke="#646A69" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M10.5 4.75L15.75 10L10.5 15.25" stroke="#646A69" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>        
            </span>                            
          </a>
        </div>
