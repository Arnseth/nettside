...
export default function IndexSectionFaq8() {
    return (
        <React.Fragment>
            <>
  ...
  <div className="container mx-auto px-4">
    <div className="flex mb-4 items-center">
      ...
      <span className="inline-block ml-2 text-sm font-medium text-white">FAQ</span>                        
    </div>
    <div className="border-t border-white border-opacity-25 pt-16">
      <div className="flex flex-wrap -mx-4">
        <div className="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
          <div className="flex flex-col h-full max-w-sm sm:max-w-lg">
            <h1 className="font-heading text-4xl sm:text-6xl text-white mb-16">Answers to the frequently asked questions.</h1>
            <div className="mt-auto">
              ...
              <div>
                <h5 className="text-xl font-medium text-white mb-4">Still have questions?</h5>
                <p className="text-white">
                  <span className="opacity-80">For assistance, please visit our</span>
                  <a href="#" className="inline-block text-white font-medium underline">Contact Us</a>
                  <span className="opacity-80">page or call our customer support hotline at</span>
                  <span className="text-white font-medium">(671) 555-0110</span>
                  <span className="opacity-80">. Our dedicated team is ready to help you on your journey to a greener, more sustainable future.</span>
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="w-full lg:w-1/2 px-4">
          <div>
            <button className="flex w-full py-6 px-8 mb-4 items-start justify-between text-left bg-white shadow-md rounded-2xl">
              <div className="pr-5">
                <h5 className="text-lg font-medium">What is green energy?</h5>
                <div className="overflow-hidden h-0 duration-500">
                  <p className="text-gray-700 mt-4">We provide a range of green energy solutions, including solar power systems, wind turbines, energy-efficient appliances.</p>
                </div>
              </div>
